 ...
 * $Id$
 *******************************************************************************/
package org.openhealthtools.mdht.uml.cda.fhim.tests;
...
public class Main {
	public static void main(String[] args) throws Exception {
		MyDocument clinicalDocument = FHIMFactory.eINSTANCE.createMyDocument().init();
		MySection section = FHIMFactory.eINSTANCE.createMySection().init();
		MyActivity act = FHIMFactory.eINSTANCE.createMyActivity().init();
