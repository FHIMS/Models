 ...
 *
 *
 * @see org.openhealthtools.mdht.uml.cda.fhim.FHIMPackage#getMySection()
...
public interface MySection extends Section {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->exists(entry : cda::Entry | entry.act.oclIsKindOf(fhim::MyActivity) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)'"
	 * @generated
	 */
